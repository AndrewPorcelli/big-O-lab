...
// ANSWER: function findFourth(arr){return arr[4]};, direct solution will have time comp of O(1)
...
// ANSWER: The first one seems more linear because it is all laid out on the same table taking up the same space. The second is all nested within multiple functions and a for loop with logic.
